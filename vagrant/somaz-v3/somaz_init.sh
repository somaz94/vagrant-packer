...
sudo mkdir -p /etc/yum.repos.d/taco_bak
sudo mv /etc/yum.repos.d/*.repo /etc/yum.repos.d/taco_bak/
...
# Windows_image Folder mount
mkdir -p /home/somaz/images
echo "192.168.183.201:/ /home/somaz/images  nfs      defaults    0       0" >> /etc/fstab
